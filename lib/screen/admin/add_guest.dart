...
class SignUpGuest extends StatefulWidget {
  const SignUpGuest({Key? key}) : super(key: key);
  @override
...
class _SignUpGuestState extends State<SignUpGuest> {
  ...
  final TextEditingController emailGuest = TextEditingController();
        ...
        actions: [
             ...
             Container(
               ...
               child: Center(
                 ...
                 child: Text(
                   "Add Guest", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16.0), ),
               ),
             ),
                  ...
                  child: InkWell(
                    onTap: () {
                      if (formKey.currentState!.validate()){
                        ...
                        emailGuest: emailGuest.text,
                        password: _password.text,
                      );
                      var requestBody = jsonEncode(guestModel);
                      ModulDaringAPIService()
                          .insertGuestData(requestBody)
                          .then((result) {
                        if (result != null) {
                          if (result.success) {
                            // pindah halaman
