...
class LaboratoryData extends StatefulWidget {
  const LaboratoryData({Key? key}) : super(key: key);

  @override
  State<LaboratoryData> createState() => _LaboratoryDataState();
}

class _LaboratoryDataState extends State<LaboratoryData> {
  @override
        ...
        actions: [
             ...
             Container(
               ...
               child: Center(
                 ...
                 child: Text(
                   "Laboratory", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16.0), ),
               ),
             ),
             CircleAvatar(
              radius: 15.0,
