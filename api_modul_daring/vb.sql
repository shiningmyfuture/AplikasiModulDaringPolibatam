...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Jan 2023 pada 13.27
...
--
-- Struktur dari tabel `tbl_attempt`
--
...
--
-- Dumping data untuk tabel `tbl_attempt`
--
...
INSERT INTO `tbl_modulpraktik` (`id_modul`, `id_matkul`, `jenis_modul`, `judul_modul`, `deskripsi_modul`, `modul_file`, `modul_link`) VALUES
(120, 17, 'Link', '566GGGGGGGGGGGGG', '556557thghghddssd', '', 'https://www.youtube.com/embed/JvKaeWJMTBg'),
(121, 17, 'File', 'tyty', 'tytutytytytytytyt', '11.007 Balasan Surat Permohonan Magang Industri_Moch Ichbal Reyvaldo.pdf', ''),
(123, 17, 'File', 'Belajar Mulmed', 'penjelasan tetang apa saja itu mulmed', 'No.BO.8.4.3.1-V2 Borang Logbook Magang.doc', ''),
(125, 18, 'File', 'Pengenalan Magang', 'Penjelasan tentang apa saja dalam matkul magang', '20221031102732107.pdf', ''),
(126, 18, 'File', 'Minggu 1', 'Materi awal', '20170222135029-Prosiding 2012.pdf', ''),
(127, 18, 'File', 'MInggu 1', 'materi 2', 'UTS Pelaporan Kerja_Febriana Riandini_4311901019.pdf', ''),
(128, 47, 'Link', 'Praktikum Flutter', 'Test', '', 'https://www.youtube.com/watch?v=f1zEJZRdo7w'),
(129, 47, 'File', 'test', 'Test', 'DIVISI ACARA 1.pdf', ''),
(130, 47, 'Link', '123', '123', '', 'https://www.youtube.com/watch?v=f1zEJZRdo7w');
...
--
-- Indeks untuk tabel `tbl_attempt`
--
...
--
-- AUTO_INCREMENT untuk tabel `tbl_attempt`
--
ALTER TABLE `tbl_attempt`
...
--
ALTER TABLE `tbl_mahasiswa`
  MODIFY `id_mhs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
...
--
ALTER TABLE `tbl_modulpraktik`
  MODIFY `id_modul` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
...
--
-- Ketidakleluasaan untuk tabel `tbl_attempt`
--
ALTER TABLE `tbl_attempt`
