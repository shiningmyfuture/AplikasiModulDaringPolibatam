...
$sql = is_numeric($orderid) ? "SELECT * FROM tbl_modulpraktik  WHERE id='$orderid' AND jenis_modul = 'File' ORDER BY judul_modul ASC" : "SELECT * FROM tbl_modulpraktik WHERE jenis_modul = 'File' ORDER BY judul_modul ASC"; 
