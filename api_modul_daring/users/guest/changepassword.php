...
if(isset($data->username) || isset($data->password) || isset($data->newpassword)){
    ...
    $get_post = "SELECT * FROM `tbl_guest` WHERE username=:username AND password=:password";
    ...
    if($get_stmt->rowCount() > 0){
        ...
        $update_query = "UPDATE `tbl_guest` SET password = :password  WHERE username = :username";        
